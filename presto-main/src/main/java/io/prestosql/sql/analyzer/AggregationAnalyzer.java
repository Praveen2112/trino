...
class AggregationAnalyzer
{
            ...
            extends AstVisitor<Boolean, Void>
    {
        ...
        {
            for (Expression expression : node.getWindowSpecification().getPartitionBy().get()) {
            ...
            for (SortItem sortItem : getSortItemsFromOrderBy(node.getWindowSpecification().getOrderBy())) {
            ...
            if (node.getWindowSpecification().getFrame().isPresent()) {
                process(node.getWindowSpecification().getFrame().get(), context);
            }
